...
#include <QPixmap>
#include <QIcon>
QPixmap new_local_image( const char* filename ); // filename is relative to local bitmaps path
QIcon new_local_icon( const char* filename ); // filename is relative to local bitmaps path
