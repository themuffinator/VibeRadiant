...
//	GlobalCommands_insert( "PatchSquareEndcap", makeCallbackF( Patch_SquareEndcap ) );
	...
	GlobalCommands_insert( "PatchInsertFirstColumn", makeCallbackF( Patch_InsertFirstColumn ), QKeySequence( QKeyCombination( Qt::ControlModifier | Qt::ShiftModifier | Qt::KeypadModifier, Qt::Key_Plus ) ) );
	GlobalCommands_insert( "PatchInsertLastColumn", makeCallbackF( Patch_InsertLastColumn ) );
	GlobalCommands_insert( "PatchInsertFirstRow", makeCallbackF( Patch_InsertFirstRow ), QKeySequence( QKeyCombination( Qt::ControlModifier | Qt::KeypadModifier, Qt::Key_Plus ) ) );
	...
	GlobalCommands_insert( "PatchDeleteLastColumn", makeCallbackF( Patch_DeleteLastColumn ), QKeySequence( QKeyCombination( Qt::ControlModifier | Qt::ShiftModifier | Qt::KeypadModifier, Qt::Key_Minus ) ) );
	GlobalCommands_insert( "PatchDeleteFirstRow", makeCallbackF( Patch_DeleteFirstRow ) );
	GlobalCommands_insert( "PatchDeleteLastRow", makeCallbackF( Patch_DeleteLastRow ), QKeySequence( QKeyCombination( Qt::ControlModifier | Qt::KeypadModifier, Qt::Key_Minus ) ) );
