...
{
	Vector3 color_gridback = { 0.77f, 0.77f, 0.77f };
	Vector3 color_gridback_coarse = { 0.70f, 0.70f, 0.70f };
	Vector3 color_gridminor = { 0.83f, 0.83f, 0.83f };
	Vector3 color_gridmajor = { 0.89f, 0.89f, 0.89f };
	Vector3 color_gridblock = { 1, 1, 1 };
	Vector3 color_gridtext = { 0.0f, 0.0f, 0.0f };
	Vector3 color_brushes = { 0, 0, 0 };
	Vector3 color_selbrushes = { 1.0f, 0.0f, 0.0f };
	Vector3 color_clipper = { 0, 0, 1 };
	Vector3 color_viewname = { 0.5f, 0.0f, 0.75f };
